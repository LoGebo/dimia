  ...
  return (
    <>
      ...
      <div className="space-y-4 px-5 py-5">
        <TiraIndicadores>
          <Cifra etiqueta="Cobrado el día" valor={moneda(resumen.cobrado)} glifo={Glifos.dinero} pildora={`${resumen.operaciones} ${resumen.operaciones === 1 ? "cobro" : "cobros"}`} tono="bueno" />
