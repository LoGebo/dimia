...
const GUION = [
  { desde: 0, duracion: 62, Plano: Gancho },
  {
    ...
    video: { desde: 16.4, zoom: 1.0, zoomFin: 1.06, foco: [0.5, 0.42] as [number, number], recorrido: 210 },
  },
  {
    desde: 258,
    duracion: 234,
    ...
    video: { desde: 30.4, zoom: 1.02, zoomFin: 1.1, foco: [0.5, 0.5] as [number, number], recorrido: 222 },
  },
  {
    desde: 480,
    duracion: 246,
    ...
    video: { desde: 35.8, zoom: 1.0, zoomFin: 1.08, foco: [0.5, 0.46] as [number, number], recorrido: 234 },
  },
  {
    desde: 714,
    duracion: 168,
    ...
    video: { desde: 46.6, zoom: 1.02, zoomFin: 1.1, foco: [0.5, 0.52] as [number, number], recorrido: 156 },
  },
